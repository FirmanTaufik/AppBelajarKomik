...
public class CustomBackgroundCurve extends FrameLayout {
    ...
    public CustomBackgroundCurve(Context context) {
        super(context);
        this.context=context;
        init();
    }

    public CustomBackgroundCurve(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public CustomBackgroundCurve(Context context, AttributeSet attrs, int defStyleAttr) {
